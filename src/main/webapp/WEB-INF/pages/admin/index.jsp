            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;"
                               layuimini-content-href="${pageContext.request.contextPath}/statics/layui/page/user-setting.html"
                               data-title="基本资料" data-icon="fa fa-gears">基本资料<span class="layui-badge-dot"></span></a>
                        </dd>
                        <dd>
                            <a href="javascript:;"
                               layuimini-content-href="${pageContext.request.contextPath}/statics/layui/page/user-password.html"
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin', 'miniTongji'], function () {
        ...
        $('.login-out').on("click", function () {
            layer.confirm('是否退出后台系统?', {icon: 3, title: '提示'}, function (index) {
                location.href = "/ShoppingSystem_war/admin/logout";
                layer.close(index);
            });
        });
    });
