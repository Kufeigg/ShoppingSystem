...
open class UserServiceImpl : UserService {
    ...
    override fun findById(bemail: String?): User {
        return userDao!!.findById(bemail)
    }
    ...
    override fun regist(bemail: String?, bpwd: String?): Int {
        return userDao!!.regist(bemail, bpwd)
    }
